...
const RegisterButton = () => {
    return (
        <div className="flex-col mt-20 sm:flex hidden">
            <Button
                href={buttonRef}
                className="w-[30vw] h-24 bg-[#E31F2B] hover:bg-white transition duraiton-100 ease-in-out group flex-row-centered rounded-sm "
                ...
                <section className="relative flex-col items-centered z-10">
                    <div className="w-screen sm:flex-row flex flex-col">
                        <div className="flex flex-col sm:flex-row sm:items-start items-center sm:justify-start mt-8 sm:mt-0 sm:ml-20 w-full">
                            <p className="w-[70vw] sm:w-[30vw] sm:h-auto 2xl:text-3xl xl:text-2xl lg:text-xl text-xl sm:text-base text-[#7c7c7c] sm:ml-0 sm:mt-10">
